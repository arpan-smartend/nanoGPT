"""
This training script can be run on a single cpu/gpu in debug mode,

To run on a single CPU/GPU, example:
...
# A single block of Self Attention --------------------------------------------------------------------------------------------------------
...
class GPTConfig:
  ...
  n_head: int = 4              # 12     -> number of heads
...
# Configuring batch size and gradient accumulation --------------------------------------------------------------------------------------------------------
...
# Checkpoints and log  --------------------------------------------------------------------------------------------------------
log_dir = 'gpt_shakespeare/log_shakespeare'
...
model_dir = 'gpt_shakespeare/model'
...
for step in range(max_steps):
  ...
  if step > 0 and step % 10 == 0:
    ...
    max_length = 32
    tokens = enc.encode('First, you know Caius Marcius is chief enemy to the people.')
